        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem;">
            ...
            <div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 2rem; flex-wrap: wrap;">
                    ...
                    <span class="btn btn-outline" style="cursor: default;">
                        <i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($wisata['lokasi']); ?>
                    </span>
                    <span class="btn btn-outline" style="cursor: default;">
                        <i class="fas fa-star"></i> <?= number_format($wisata['rating'], 1); ?>
                    </span>
                </div>
            ...
            <!-- <div>
                ...
                <div style="background: white; padding: 2rem; border-radius: 1rem; box-shadow: var(--shadow-md); text-align: center; margin-bottom: 1.5rem;">
                    ...
                    <a href="<?= htmlspecialchars($wisata['link_maps']); ?>" 
                        target="_blank" 
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <button onclick="toggleFavorite(this, <?= $id_wisata; ?>)" 
                            ...
                            data-wisata-id="<?= $id_wisata; ?>">
                        <i class="fas fa-heart"></i> 
                        <?= $is_favorited ? 'Hapus dari Favorite' : 'Tambah ke Favorite'; ?>
                    </button>
                <?php else: ?>
